...
1. In your Visual Studio Code, ask the **GitHub Copilot Chat** to generate a sysadmin script that **monitors CPU and memory usage with a threshold limit for a Linux VM**, and copy the script to a new file.

   ![](../../media/18-06-25-s6-1.png)
...
1. Search for `powershell ise` **(1)** in the start menu, right-click on **Windows PowerShell ISE** **(2)**, and select **Run as administrator** **(3)**, copy and paste the PowerShell script that monitors disk usage in a new file, run the script, and verify the results.

   ![](../../media/18-06-25-s6-4.png)
